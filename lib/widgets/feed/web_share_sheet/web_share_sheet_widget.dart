...
class _WebShareSheetWidgetState extends State<WebShareSheetWidget> {
  ...
  void initState() {
    ...
    _model.textController ??= TextEditingController(
        text:
            'Take a look at this pet  https://www.google.com/bfyuukbftryhbvgujnjytyjj');
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Copy this message and URL and send to your family and friends in your favorite app.',
            ...
            FFButtonWidget(
              onPressed: () async {
                logFirebaseEvent('WEB_SHARE_SHEET_COMP_CLOSE_BTN_ON_TAP');
